...
export const Peer: MessageFns<Peer> = {
  encode(message: Peer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.joinTime !== undefined) {
      Timestamp.encode(toTimestamp(message.joinTime), writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const HubInfoMessage: MessageFns<HubInfoMessage> = {
  encode(message: HubInfoMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    ...
    for (const v of message.peers) {
      Peer.encode(v!, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): HubInfoMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const PeerJoinedMessage: MessageFns<PeerJoinedMessage> = {
  encode(message: PeerJoinedMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PeerJoinedMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const PeerDisconnectedMessage: MessageFns<PeerDisconnectedMessage> = {
  encode(message: PeerDisconnectedMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.peerId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PeerDisconnectedMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const OfferMessage: MessageFns<OfferMessage> = {
  encode(message: OfferMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): OfferMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const IceCandidateMessage: MessageFns<IceCandidateMessage> = {
  encode(message: IceCandidateMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.peerId !== "") {
      writer.uint32(10).string(message.peerId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): IceCandidateMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ServerMessage: MessageFns<ServerMessage> = {
  encode(message: ServerMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hubInfoMessage !== undefined) {
      HubInfoMessage.encode(message.hubInfoMessage, writer.uint32(10).fork()).join();
    }
    if (message.peerJoinedMessage !== undefined) {
      PeerJoinedMessage.encode(message.peerJoinedMessage, writer.uint32(18).fork()).join();
    }
    if (message.peerDisconnectedMessage !== undefined) {
      PeerDisconnectedMessage.encode(message.peerDisconnectedMessage, writer.uint32(26).fork()).join();
    }
    if (message.offerMessage !== undefined) {
      OfferMessage.encode(message.offerMessage, writer.uint32(34).fork()).join();
    }
    if (message.answerMessage !== undefined) {
      AnswerMessage.encode(message.answerMessage, writer.uint32(42).fork()).join();
    }
    if (message.iceCandidateMessage !== undefined) {
      IceCandidateMessage.encode(message.iceCandidateMessage, writer.uint32(50).fork()).join();
    }
    return writer;
  },
