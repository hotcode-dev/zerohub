...
export const SendOfferMessage: MessageFns<SendOfferMessage> = {
  encode(message: SendOfferMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SendOfferMessage {
...
export const SendAnswerMessage: MessageFns<SendAnswerMessage> = {
  encode(message: SendAnswerMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SendAnswerMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SendIceCandidateMessage: MessageFns<SendIceCandidateMessage> = {
  encode(message: SendIceCandidateMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.peerId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SendIceCandidateMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdatePeerMetadataMessage: MessageFns<UpdatePeerMetadataMessage> = {
  encode(message: UpdatePeerMetadataMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.peerId !== "") {
      writer.uint32(10).string(message.peerId);
    }
    if (message.metadata !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdatePeerMetadataMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ClientMessage: MessageFns<ClientMessage> = {
  encode(message: ClientMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sendOfferMessage !== undefined) {
      SendOfferMessage.encode(message.sendOfferMessage, writer.uint32(10).fork()).join();
    }
    if (message.sendAnswerMessage !== undefined) {
      SendAnswerMessage.encode(message.sendAnswerMessage, writer.uint32(18).fork()).join();
    }
    if (message.sendIceCandidateMessage !== undefined) {
      SendIceCandidateMessage.encode(message.sendIceCandidateMessage, writer.uint32(26).fork()).join();
    }
    if (message.updatePeerMetadataMessage !== undefined) {
      UpdatePeerMetadataMessage.encode(message.updatePeerMetadataMessage, writer.uint32(34).fork()).join();
    }
    return writer;
  },
